    ...
    addMemo = () => {
        ...
        var memoEntryConverter = {
            ...
            fromFireStore: function(snapshot, options) {
                ...
                return new MemoEntry(data.time, data.title, data.content, data.badge1, data.badgeColor1, data.badge2, data.badgeColor2, data.badge3, data.badgeColor3, data.badge4, data.badgeColor4);
            }
        };

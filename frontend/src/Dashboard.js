    ...
    return (
        ...
        <div id="dashboard">
            ...
            <div id="wave-animation">
                ...
                <g class="parallax">
                <use xlinkHref="#gentle-wave" x="10" y="0" fill="rgba(255,232,214,0.3)" />
                <use xlinkHref="#gentle-wave" x="20" y="3" fill="rgba(255,232,214,0.5)" />
                <use xlinkHref="#gentle-wave" x="30" y="5" fill="rgba(255,232,214,0.7)" />
                <use xlinkHref="#gentle-wave" x="0" y="7" fill="rgba(255,232,214,0.9)" />
                </g>
                </svg>
                </div>
            </div>
